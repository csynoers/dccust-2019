        ...
        <div class='col-sm-12'>
            <div class='panel panel-primary'>
                <div class='panel-heading'>
                    <H4><i class='fa fa-pencil-square-o' aria-hidden='true'></i> Add Informasi Artikel</H4>
                </div>
                    ...
                    <form method='POST' enctype='multipart/form-data' action='?module={$this->module}&act=store'>
                        <div class='container-fluid'>
                            <div class='form-group'>
                                ...
                                <input placeholder='Masukan Judul ...' name='nama_artikel' type='text' value='' class='form-control'>
                            </div>
                            <div class='form-group'>
                                <label for='deskripsi'>Deskripsi :</label>
                                <textarea name='isi_artikel' class='form-control myTextarea'></textarea>
                            </div>
                            <div class='form-group'>
