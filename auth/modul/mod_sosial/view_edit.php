                ...
                <div class='panel panel-primary'>
                    <form method='POST' enctype='multipart/form-data' action='?module={$this->url->module}&act=store'>
                        <div class='panel-heading bg-primary'>
                            <h4><i class='fa fa-pencil-square-o' aria-hidden='true'></i> Edit Informasi Sosial Media</h4>
                        </div>
                        <!-- /.panel-heading -->
                        ...
                        <div class='panel-body'>
                            <div class='container-fluid'>
                                <div class='form-group'>
                                    ...
                                    <input value='{$value->nama}' name='nama' type='text' class='form-control' id='judul' placeholder='Masukan judul...' required>
                                </div>
                                <div class='form-group'>
                                    <label for='link'>Link :</label>
                                    <input value='{$value->link}' type='text' name='link' class='form-control' id='link' placeholder='Link sosial media jika ada jika tidak cukup masukan tanda #' required>
                                </div>
                                <div class='form-group'>
