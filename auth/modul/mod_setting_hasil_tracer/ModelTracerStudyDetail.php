<?php
    class ModelTracerStudyDetail extends dbHelper
    {
        ...
        {
            if ( empty($id) ) {
                return $this->db->get_select("SELECT * FROM settings WHERE settings.category='setting-hasil-tracer' ORDER BY settings.title ASC")['data'];
        ...
        public function insert_settings()
        {
            ...
            $columnsArray           = [
                ...
                'options'=> json_encode($_POST['tracer_study_id']),
                'category'=> 'setting-hasil-tracer',
