                ...
                <div class='panel panel-primary'>
                    <form method='POST' enctype='multipart/form-data' action='?module={$this->url->module}&act=store'>
                        <div class='panel-heading bg-primary'>
                            <h4><i class='fa fa-pencil-square-o' aria-hidden='true'></i> Edit Informasi SEO Title Website</h4>
                        </div>
                        <!-- /.panel-heading -->
                        ...
                        <div class='panel-body'>
                            <div class='container-fluid'>
                                <div class='form-group'>
                                    <label>Title</label>
                                    <input class='form-control' name='static_content_en' value='{$value->static_content_en}' required>
                                </div>
                            </div>
                        </div>
                        <!-- /.panel-body -->
