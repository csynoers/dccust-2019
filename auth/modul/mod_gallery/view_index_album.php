        ...
        <nav class="navbar navbar-default" style="margin-bottom: 0px">
            <div class="container-fluid">
                <div class="navbar-header">
                    <a class="navbar-brand" href="#"><i class="fa fa-info-circle" aria-hidden="true"></i> Daftar Informasi Galeri Album Foto</a>
                </div>
                            ...
                            echo "
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href='?module={$this->url->module}&data={$this->url->data}&act=delete&id={$value->id_album}' onclick=\"return confirm('Apakah anda yakin menghapus data ini?')\">
