            ...
            <div class='col-sm-12'>
                <div class='panel panel-primary'>
                    <div class='panel-heading'>
                        <H4><i class='fa fa-pencil-square-o' aria-hidden='true'></i> Edit Informasi Galeri Foto</H4>
                    </div>
                        ...
                        <form method='POST' enctype='multipart/form-data' action='?module={$this->url->module}&data={$this->url->data}&act=store'>
                            <div class='container-fluid'>
                                ...
                                <div class='form-group'>
                                    ...
                                    <div class='row'>
                                        <div class='col-sm-4'>
                                            <img class='img-responsive' src='{$this->config->img[$this->url->data]['dir']}{$value->gambar}'>
                                        </div>
                                    </div>
                                </div>
                                <div class='form-group'>
                            ...
                            <input type='hidden' name='id_album' value='{$_GET['parent']}'>
