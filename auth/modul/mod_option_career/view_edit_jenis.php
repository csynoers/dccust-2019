...
<div class="container-fluid">
	<div class="col-sm-12">
		<form method='POST' enctype='multipart/form-data' action="?module=option_career&act=edit&opt=jenis&id=<?php echo $id ?>&saving=1">
	        <div class="panel panel-default">
				<div class="panel-heading">
					<h3><b><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit Jenis Lowongan</b></h3>
				</div>
