...
<div class="container-fluid">
	<div class="col-sm-12">
		<form method='POST' enctype='multipart/form-data' action='<?php echo "?module={$this->module}&act=store_jenis_lowongan"; ?>'>
	        <div class="panel panel-default">
	            ...
	            <div class="panel-body">
					<div class="form-group">
						...
						<input placeholder="Masukan jenis lowongan ..." class="form-control" name="name" type="text" required="">
					</div>
	            </div>
