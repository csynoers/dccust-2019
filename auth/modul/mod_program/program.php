...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
	...
	<nav class="navbar navbar-default">
		...
		<div class="panel-body">
			...
			<?php 	
				$no=1;
				$program = $db->get_select("SELECT * FROM program ORDER BY id_program DESC");
				foreach ($program['data'] as $key => $b){
			...
			<form method='POST' enctype='multipart/form-data' action='<?php echo "$aksi"; ?>?module=<?php echo $module;?>&act=insertnew'>
				<div class="container-fluid">
					<div class="form-group">
						...
						<input name="nama_program" type="text" class="form-control">
					</div>
					<div class="form-group">
						<label for="deskripsi">Deskripsi :</label>
						<textarea name="isi_program" id="jogmce"></textarea>
					</div>
					<div class="form-group">
...
<?php break; 
	case"edit":
	$program = $db->get_select("SELECT * FROM program WHERE id_program='$_GET[id]'");
	$r= $program['data'][0];
?>
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
	<div class="panel panel-primary">
		<div class="panel-heading">
			<h4><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit Program</h4>
		</div>
		<div class="panel-body">
			<form method='POST' enctype='multipart/form-data' action='<?php echo "$aksi"; ?>?module=<?php echo $module;?>&act=update'>
				<div class="container-fluid">
					<input type='hidden' name='id' value='<?php echo"$r->id_program" ?>'>
					<div class="form-group">
						<label for="judul">Judul :</label>
						<input class="form-control" name="nama_program" type="text" value="<?php echo"$r->nama_program" ?>">
					</div>
					<div class="form-group">
						<label for="deskripsi">Deskripsi :</label>
						<textarea name="isi_program" id="jogmce"><?php echo"$r->isi_program" ?></textarea>
					</div>
					<div class="form-group">
						<label for="thumbnail">Thumbnail :</label>
						<img class="img-responsive" src="../joimg/program/<?php echo"$r->gambar" ?>">
					</div>
					<div class="form-group">
...
<?php break; 
	case"update_header":
	$header = $db->get_select("SELECT * FROM header WHERE id_header='14' AND aktif='Y'");
	$h= $header['data'][0];
...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
	<div class="panel panel-primary">
		<div class="panel-heading">
			<h4><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit Header Program</h4>
		</div>
		<div class="panel-body">
			<form method='POST' enctype='multipart/form-data' action='<?php echo "$aksi"; ?>?module=program&act=update_header'>
				<div class="container-fluid">
					...
					<div class="form-group">
						<label for="change_thumbnail">Change Tumbnail :</label>
						<input type="file" name="fupload">
					</div>
					<div class="form-group">
						<div class="alert alert-info">
