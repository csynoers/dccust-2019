        ...
        <nav class="navbar navbar-default" style="margin-bottom: 0px">
            <div class="container-fluid">
                <div class="navbar-header">
                    <a class="navbar-brand" href="#"><i class="fa fa-info-circle" aria-hidden="true"></i> Daftar Informasi Program</a>
                </div>
                        ...
                        foreach ($rows as $key => $value) {
                            echo "
                                <tr>
                                    ...
                                    <td>
                                        <a href='?module={$this->module}&act=edit&id={$value->id_program}'>
                                            <input type='image' src='images/icn_edit.png' title='Edit'>
                                        </a> &nbsp;&nbsp;&nbsp;&nbsp;
                                        <a href='?module={$this->module}&act=delete&id={$value->id_program}' onclick=\"return confirm('Apakah anda yakin menghapus data ini?')\">
