                        ...
                        foreach ($rows as $key => $value) {
                            echo "
                                <tr>
                                    ...
                                    <td>
                                        <a href='?module={$this->url->module}&act=edit&id={$value->id_fakultas}'>
                                            <input type='image' src='images/icn_edit.png' title='Edit'>
                                        </a> &nbsp;&nbsp;&nbsp;&nbsp;
                                        <a href='?module={$this->url->module}&act=delete&id={$value->id_fakultas}' onclick=\"return confirm('Apakah anda yakin menghapus data ini?')\">
