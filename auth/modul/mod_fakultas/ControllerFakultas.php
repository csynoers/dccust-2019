<?php
    class ControllerFakultas
    {
        public function __construct($db_config){
			$this->Model 	= new ModelFakultas($db_config);
			$this->aksi		= 'modul/mod_fakultas/ControllerFakultas.php';
	...
	$load= new ControllerFakultas($db_config);
