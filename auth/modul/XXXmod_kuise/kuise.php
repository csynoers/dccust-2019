	...
	<?php
		$aksi="modul/mod_kuise/aksi_kuise.php";
		$print = "modul/mod_kuise/aksi_export.php";
		$module="kuise";
								...
								$kuise = mysql_query("
											...
											FROM alumni_daftar
												INNER JOIN prodi 
													ON (alumni_daftar.prodi = prodi.id_prodi)
												INNER JOIN tb_e 
													ON (alumni_daftar.id_alumni = tb_e.id_alumni)
											ORDER BY alumni_daftar.nim ASC
										");
							}
							while($b=mysql_fetch_assoc($kuise)){
							?>
							<tr>  
