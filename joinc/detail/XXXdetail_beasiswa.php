		...
		<div class="row">
			...
			<div class="col-lg-12">
				...
				<div class="row" style="margin-top: 19px; margin-bottom: 50px;"> 
					<?php 
						$publikasi=mysql_query("SELECT * FROM beasiswa where id_beasiswa='$_GET[id]'");
					...
					<article>
						<div class="post-image">
							<div class="post-heading">
								<h3><a href="#"><?php echo "$f[nama_beasiswa]"; ?></a></h3>
							...
							<img style="max-width: 70%" src="joimg/beasiswa/<?php echo"$f[gambar]"; ?>" alt="" />
						</div>
						<?php echo"$f[isi_beasiswa]"; ?>	
					</article>					
